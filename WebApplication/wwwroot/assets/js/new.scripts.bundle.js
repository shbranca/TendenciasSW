        ...
        e.fn.mDatatable = function (t) {
            if (0 !== e(this).length) {
                ...
                var n = {
                    ...
                    extractTable: function () {
                        var n = [],
                            o = e(a).find("tr:first-child th").get().map(function (a, o) {
                                var i, l = e(a).data("field");
                                void 0 === l && (l = e(a).text().trim()), i = void 0 === e(a).data("title") ? {
                                    field: l,
                                    title: l
                                } : {
                                        field: l,
                                ...
                                for (var r in t.columns) t.columns[r].field === l && (i = e.extend(!0, {}, t.columns[r], i));
                                return n.push(i), l
                            });
                        t.columns = n;
                        var i = [],
                                ...
                                e(a).find(".m-datatable__cell").each(function (t, a) {
                                    ...
                                    if (void 0 !== i) {
                                        ...
                                        if (void 0 !== i.selector && !1 !== i.selector) {
                                            ...
                                            void 0 !== i.selector.class && e(r).addClass(i.selector.class), void 0 !== i.selector.name && e(r).children("input[type='checkbox']:first").attr("name", i.selector.name), e(a).children().html(r)
                                        }
                                    ...
                                    e(t).find("li").show(), e.each(n.getOption("toolbar.items.pagination.pages"), function (a, r) {
                                        if (mUtil.isInResponsiveRange(a)) {
                                            switch (a) {
                                                case "desktop":
                                                case "tablet":
                                                    Math.ceil(o / r.pagesNumber), r.pagesNumber, r.pagesNumber, e(l).hide(), i.meta = n.getDataSourceParam("pagination"), i.paginationUpdate();
                                                    break;
                                                case "mobile":
                    ...
                    reload: function () {
                        return o = n.getOption("search.delay"), clearTimeout(n.timer), n.timer = setTimeout(function () {
                    ...
                    destroy: function () {
                        ...
                        return e(a).replaceWith(t), e(a = t).trigger("m-datatable--on-destroy"), n.isInit = !1, null
                    },
                    sort: function (t, o) {
    ...
    if (t = mUtil.get("body").querySelectorAll('.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]'))
        for (var a = 0, n = t.length; a < n; a++) {
            ...
            if (o) {
                ...
                if (e.target !== o && !1 === o.contains(e.target) && (i = o.querySelectorAll('.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)[m-menu-submenu-toggle="click"]')))
                ...
                r = {
                    ...
                    setupTooltips: function () {
                        if (a.options.tooltips) {
                            ...
                            s && (l = t ? "bottom" : "top", r = new Tooltip(s, {
                            ...
                            d && (l = t ? "bottom" : "top", r = new Tooltip(d, {
                            ...
                            c && (l = t ? "bottom" : "top", r = new Tooltip(c, {
                ...
                l = {
                    ...
                    updateProgress: function () {
                        if (a.progress)
                            ...
                            } else e = a.currentStep / a.totalSteps * 100, mUtil.css(a.progress, "width", e + "%")
                    },
        ...
        init: function () {
            0 !== e.length && new mOffcanvas("m_quick_sidebar", {
                ...
                mApp.block(e), setTimeout(function () {
                    mApp.unblock(e), a.removeClass("m--hide"),
                        function () {
